...
public class IssueTypeServiceImpl implements IssueTypeService {
    ...
    @Autowired
    private IssueTypeTransactionService issueTypeTransactionService;
...
//        }
    ...
    public IssueTypeDTO clone(Long cloneId) {
        IssueType issueType = issueTypeMapper.selectByPrimaryKey(cloneId);
        IssueTypeDTO issueTypeDTO = modelMapper.map(issueType, IssueTypeDTO.class);
        issueTypeDTO.setId(null);
        return issueTypeTransactionService.create(issueTypeDTO);
    }
}
